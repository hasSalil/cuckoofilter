...
class CuckooFilter {
  // Storage of items
  SingleTable<bits_per_item> *table_;
...
template <typename ItemType, size_t bits_per_item>
Status CuckooFilter<ItemType, bits_per_item>::AddImpl(
...
template <typename ItemType, size_t bits_per_item>
Status CuckooFilter<ItemType, bits_per_item>::Contain(
...
template <typename ItemType, size_t bits_per_item>
Status CuckooFilter<ItemType, bits_per_item>::Delete(
    const ItemType &key) {
  size_t i1, i2;
  uint32_t tag;
...
template <typename ItemType, size_t bits_per_item>
std::string CuckooFilter<ItemType, bits_per_item>::Info() const {
  std::stringstream ss;
